...
The first iterarion in an experiement in React optimization and creating a class based framework for 8-bit arcade games. Designed and built by Adam Meza.
...
>[!NOTE]
> This is the first iteration of what is an ongoing project. If you are a React/frontend developer interested in giving feedback or contributing to this project, please contact me via [LinkedIn](https://linkedin.com/in/adam-meza). 
